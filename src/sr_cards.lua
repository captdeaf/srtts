...
EFFECTS:
  ...
  Simple effects:
    ...
    tradescrap={count=2}: Scrap up to 2 cards in trade row
    oppdiscard=1: Opponent discards 1
    mayscrap={from={S_HAND}, count=2}: May Scrap 2 cards from hand
    mustscrap={{S_HAND}, 1}: Must Scrap 1 card from hand
...
CARDDEFS = {
  ...
  { "Fortress Oblivion", OUTPOST, {MC}, 3, {def=4, check={"play:base", 1, {mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}, true}}},
  { "Frontier Station", OUTPOST, {MC}, 6, {def=6, choose={{t=2},{d=3}}}},
  { "Imperial Palace", OUTPOST, {SE}, 7, {def=6, draw=1, oppdiscard=1, se={d=4}}},
  { "Junkyard", OUTPOST, {MC}, 6, {def=5, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}},
  { "Lookout Post", OUTPOST, {MC, TF}, 7, {def=6, draw=1}},
  { "Machine Base", OUTPOST, {MC}, 7, {def=6, onactivate={draw=1, mustscrap={from={S_HAND}, count=1}}}},
  { "Mech World", OUTPOST, {MC}, 5, {def=6, ally={MC, SE, TF, BB}}},
  { "Port of Call", OUTPOST, {TF}, 6, {def=6, t=3, onscrap={draw=1, destroybase=1}}},
  { "Recycling Station", OUTPOST, {SE}, 4, {def=4, choose={{recycle={count=2}},{t=1}}}},
  ...
  { "Supply Depot", OUTPOST, {SE}, 6, {def=5, mayuse={count=2, effects={choose={{t=2},{d=2}}}, from={S_HAND}, to=TO_DISCARD, cardmessage="discards %s for 2 damage or trade"}, se={draw=1}}},
  ...
  { "Acceptable Losses", GAMBIT, {UA}, -1, {onscrap={mayscrap={from={S_HAND}, count=2}}}},
  ...
  { "Salvage Operation", GAMBIT, {UA}, -1, {onscrap={discardtotop={count=1}}}},
  ...
  { "CEO Shaner", HERO, {UA}, 5, {onplay={ally={TF}, onactivate={uniq={"freecard", {SHIP, OUTPOST, BASE}, 3, TO_TOP}}}, onscrap={draw=1, ally={TF}}}},
  { "CEO Torres", HERO, {UA}, 2, {onscrap={a=7,ally={TF}}}},
  { "Chairman Haygan", HERO, {UA}, 3, {onplay={ally={TF}, a=4}, onscrap={a=4, ally={TF}}}},
  { "Chancellor Hartman", HERO, {UA}, 4, {onplay={ally={MC}, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}, onscrap={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, ally={MC}}}},
  { "Commander Klik", HERO, {UA}, 4, {onplay={ally={SE}, recycle={count=1}}, onscrap={recycle={count=1}, ally={SE}}}},
  { "Commodore Zhang", HERO, {UA}, 5, {onplay={ally={SE}, d=5, oppdiscard=1}, onscrap={draw=1, ally={SE}}}},
  { "Confessor Morris", HERO, {UA}, 5, {onplay={ally={MC}, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=2}}, onscrap={draw=1, ally={MC}}}},
  { "Cunning Captain", HERO, {UA}, 1, {onscrap={oppdiscard=1, ally={SE}}}},
  { "High Priest Lyle", HERO, {UA}, 2, {onscrap={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, ally={MC}}}},
  { "Hive Lord", HERO, {UA}, 5, {onplay={ally={BB}, d=2, tradescrap={count=5}}, onscrap={draw=1, ally={BB}}}},
  { "Ram Pilot", HERO, {UA}, 1, {onscrap={d=2, ally={BB}}}},
  { "Screecher", HERO, {UA}, 3, {onplay={ally={BB}, d=2, tradescrap={count=1}}, onscrap={tradescrap={count=1}, d=2, ally={BB}}}},
  { "Special Ops Director", HERO, {UA}, 1, {onscrap={a=4, ally={TF}}}},
  { "War Elder", HERO, {UA}, 1, {onscrap={mayscrap={from={S_HAND}, count=1}, ally={MC}}}},
  ...
  { "Battle Mech", SHIP, {MC}, 5, {d=4, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={draw=1}}},
  { "Battle Pod", SHIP, {BB}, 2, {d=4, tradescrap={count=1}, bb={d=2}}},
  { "Battle Screecher", SHIP, {BB}, 4, {d=5, tradescrap={count=5}, bb={t=2}}},
  { "Blob Bot", SHIP, {BB, MC}, 3, {d=5, bb={t=2}, mc={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}}},
  { "Blob Carrier", SHIP, {BB}, 6, {d=7, bb={onactivate={uniq={"freecard", {SHIP}, 100, TO_TOP}}}}},
  { "Blob Destroyer", SHIP, {BB}, 4, {d=6, bb={destroybase=1, tradescrap={count=1}}}},
  ...
  { "Convoy Bot", SHIP, {MC}, 3, {d=4, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={d=2}}},
  { "Corvette", SHIP, {SE}, 2, {d=1, draw=1, se={d=2}}},
  { "Customs Frigate", SHIP, {TF}, 4, {onactivate={uniq={"freecard", {SHIP}, 4, TO_TOP}}, tf={d=4}, onscrap={draw=1}}},
  { "Cutter", SHIP, {TF}, 2, {t=2, a=4, tf={d=4}}},
  { "Defense Bot", SHIP, {MC}, 2, {d=1, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, check={"my:base", 2, {d=8}}}},
  ...
  { "Leviathan", SHIP, {BB}, 8, {d=9, draw=1, destroybase=1, bb={onactivate={uniq={"freecard", {SHIP}, 3, TO_HAND}}}}},
  { "Mech Cruiser", SHIP, {MC}, 5, {d=6, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={destroybase=1}}},
  { "Megahauler", SHIP, {TF}, 7, {a=5, onactivate={uniq={"freecard", {SHIP}, 100, TO_TOP}}, tf={draw=1}}},
  { "Mega Mech", SHIP, {MC}, 5, {d=6, uniq={"mayreturn", {BASE, OUTPOST}, 1}, mc={draw=1}}},
  { "Merc Cruiser", SHIP, {UA}, 3, {d=5, mercenary=true}},
  { "Mining Mech", SHIP, {MC}, 4, {t=3, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={d=3}}},
  { "Missile Bot", SHIP, {MC}, 2, {d=2, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={d=2}}},
  { "Missile Mech", SHIP, {MC}, 6, {d=6, destroybase=1, mc={draw=1}}},
  { "Moonwurm", SHIP, {BB}, 7, {d=8, draw=1, bb={onactivate={uniq={"freecard", {}, 2, TO_HAND}}}}},
  { "Obliterator", SHIP, {BB}, 6, {d=7, check={"enemy:base", 2, {d=6}}, bb={draw=1}}},
  { "Parasite", SHIP, {BB}, 5, {choose={{d=6},{onactivate={uniq={"freecard", {}, 6, TO_DISCARD}}}}, bb={draw=1}}},
  { "Patrol Bot", SHIP, {MC}, 2, {choose={{t=2},{d=4}}, mc={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}}},
  { "Patrol Cutter", SHIP, {TF}, 3, {t=2, d=3, tf={a=4}}},
  { "Patrol Mech", SHIP, {MC}, 4, {choose={{t=3},{d=5}}, mc={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}}},
  { "Peacekeeper", SHIP, {TF}, 6, {d=6, a=6, tf={draw=1}}},
  { "Predator", SHIP, {BB}, 2, {d=4, bb={draw=1}}},
  { "Ram", SHIP, {BB}, 3, {d=5, bb={d=2}, onscrap={t=3}}},
  { "Ravager", SHIP, {BB}, 3, {d=6, tradescrap={count=2}}},
  { "Repair Bot", SHIP, {MC}, 2, {t=2, mayscrap={from={S_PLAYER_DISCARD}, count=1}, onscrap={d=2}}},
  { "Scout", SHIP, {UA}, 0, {t=1}},
  { "Solar Skiff", SHIP, {TF}, 1, {t=2, tf={draw=1}}},
  { "Spike Pod", SHIP, {BB}, 1, {d=3, tradescrap={count=2}, onscrap={d=2}}},
  { "Star Barge", SHIP, {SE}, 1, {t=2, se={d=2, oppdiscard=1}}},
  { "Stealth Needle", SHIP, {MC}, 4 , {uniq={"stealthneedle"}}},
  { "Supply Bot", SHIP, {MC}, 3, {t=2, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={d=2}}},
  { "Survey Ship", SHIP, {SE}, 3, {t=1, draw=1, onscrap={oppdiscard=1}}},
  { "Swarmer", SHIP, {BB}, 1, {d=3, tradescrap={count=1}, bb={d=2}}},
  { "The Ark", SHIP, {MC}, 7, {d=5, scrapcycle={from={S_HAND, S_PLAYER_DISCARD}, count=2}, onscrap={destroybase=1}}},
  { "The Wrecker", SHIP, {MC}, 7, {d=6, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=2}, mc={draw=1}}},
  { "Trade Bot", SHIP, {MC}, 1, {t=1, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={d=2}}},
  ...
  { "Unity Fighter", SHIP, {MC,BB}, 1, {d=3, tradescrap={count=1}, onscrap={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}}},
  { "Viper", SHIP, {UA}, 0, {d=1}},
  ...
  { "Destroyer Bot", SHIP, {MC}, 3, {d=5, mayscrap={from={S_PLAYER_DISCARD}, count=1}}},
  { "Enforcer Mech", SHIP, {MC}, 5, {d=5, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}, mc={destroybase=1}, onscrap={draw=1}}},
  { "Integration Port", OUTPOST, {MC}, 3, {def=5, t=1}},
  { "Nanobot Swarm", SHIP, {MC}, 8, {d=5, draw=2, mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=2}}},
  { "Neural Nexus", OUTPOST, {MC}, 7, {def=6, scrapfor={from={S_HAND, S_PLAYER_DISCARD}, effects={d="cost"}, cardmessage="scraps %s for damage (equal to cost)"},  mc={draw=1}}},
  { "Plasma Bot", SHIP, {MC}, 2, {d=3, mayscrap={from={S_HAND}, count=1}, mc={d=2}}},
  { "Reclamation Station", OUTPOST, {MC}, 6, {def=6, mayscrap={from={S_PLAYER_DISCARD}, count=1}, onscrap={uniq="reclamation"}}},
  { "Repair Mech", SHIP, {MC}, 4, {choose={t=3, {discardtotop={check={"type", {BASE, OUTPOST}}, count=1}}}, mc={mayscrap={from={S_HAND, S_PLAYER_DISCARD}, count=1}}}},
  ...
  { "Gateship", SHIP, {TF}, 6, {onactivate={uniq={"freecard", {SHIP, OUTPOST, BASE}, 6, TO_TOP}}, tf={a=5}}},
