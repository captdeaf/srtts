...
CARDDEFS = {
  ...
  { "Conversion Yard", OUTPOST, {MC}, 5, {def=4, scrapcycle={from={S_HAND}, count=1, effects={d=4}}}},
  ...
  { "Neural Nexus", OUTPOST, {MC}, 7, {def=6, scrapcycle={from={S_HAND, S_PLAYER_DISCARD}, effects={d="cost"}},  mc={draw=1}}},
